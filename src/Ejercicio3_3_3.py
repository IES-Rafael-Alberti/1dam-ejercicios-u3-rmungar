...
def conjuntoPotencia(conjunto_original: set) -> list:
    ...
    for elemento in conjunto_original:
        ...
        for subconjunto in potencia:
            ...
            nuevo_subconjunto.append(subconjunto|{elemento})
        
        # TODO: Agregar los nuevos subconjuntos a la lista potencia:
        potencia.extend(nuevo_subconjunto)
...
def main():
    ...
    resultado = conjuntoPotencia(conjunto_original)
